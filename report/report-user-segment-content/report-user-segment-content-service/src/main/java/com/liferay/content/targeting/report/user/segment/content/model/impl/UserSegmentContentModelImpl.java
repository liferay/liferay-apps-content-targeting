...
public class UserSegmentContentModelImpl extends BaseModelImpl<UserSegmentContent>
	...
	public static final String TABLE_SQL_CREATE = "create table CT_USCR_UserSegmentContent (userSegmentContentId LONG not null primary key,companyId LONG,userSegmentId LONG,classNameId LONG,classPK LONG,eventType VARCHAR(75) null,count INTEGER,modifiedDate DATE null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.report.user.segment.content.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.content.targeting.report.user.segment.content.model.UserSegmentContent"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.report.user.segment.content.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.content.targeting.report.user.segment.content.model.UserSegmentContent"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.report.user.segment.content.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.content.targeting.report.user.segment.content.service.util.ServiceProps.get(
	...
	public Object clone() {
		...
		userSegmentContentImpl.setClassNameId(getClassNameId());
	...
	public void resetOriginalValues() {
		...
		userSegmentContentModelImpl._originalClassNameId = userSegmentContentModelImpl._classNameId;

		userSegmentContentModelImpl._setOriginalClassNameId = false;
	...
	public CacheModel<UserSegmentContent> toCacheModel() {
		...
		userSegmentContentCacheModel.classNameId = getClassNameId();
