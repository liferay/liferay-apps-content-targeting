...
public class CampaignContentUtil {
	...
	*/
	public static CampaignContent findByC_C_C_E(long campaignId,
		...
		throws com.liferay.content.targeting.report.campaign.content.exception.NoSuchCampaignContentException {
		return getPersistence()
				   .findByC_C_C_E(campaignId, classNameId, classPK, eventType);
	}
	...
	*/
	public static CampaignContent fetchByC_C_C_E(long campaignId,
		long classNameId, long classPK, java.lang.String eventType) {
		return getPersistence()
				   .fetchByC_C_C_E(campaignId, classNameId, classPK, eventType);
	}
	...
	*/
	public static CampaignContent removeByC_C_C_E(long campaignId,
		...
		throws com.liferay.content.targeting.report.campaign.content.exception.NoSuchCampaignContentException {
		return getPersistence()
				   .removeByC_C_C_E(campaignId, classNameId, classPK, eventType);
	}
	...
	* @return the number of matching campaign contents
	*/
	public static int countByC_C_C_E(long campaignId, long classNameId,
		long classPK, java.lang.String eventType) {
		return getPersistence()
				   .countByC_C_C_E(campaignId, classNameId, classPK, eventType);
	}
