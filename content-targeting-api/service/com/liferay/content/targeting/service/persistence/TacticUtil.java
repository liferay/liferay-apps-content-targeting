...
public class TacticUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(TacticUtil.class);

		_serviceTracker = new ServiceTracker<TacticPersistence, TacticPersistence>(bundle.getBundleContext(),
				TacticPersistence.class, null);
