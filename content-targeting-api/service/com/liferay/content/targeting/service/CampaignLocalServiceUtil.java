...
public class CampaignLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(CampaignLocalServiceUtil.class);

		_serviceTracker = new ServiceTracker<CampaignLocalService, CampaignLocalService>(bundle.getBundleContext(),
				CampaignLocalService.class, null);
