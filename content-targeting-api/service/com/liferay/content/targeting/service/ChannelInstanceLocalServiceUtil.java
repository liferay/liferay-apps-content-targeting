...
public class ChannelInstanceLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(ChannelInstanceLocalServiceUtil.class);

		_serviceTracker = new ServiceTracker<ChannelInstanceLocalService, ChannelInstanceLocalService>(bundle.getBundleContext(),
				ChannelInstanceLocalService.class, null);
