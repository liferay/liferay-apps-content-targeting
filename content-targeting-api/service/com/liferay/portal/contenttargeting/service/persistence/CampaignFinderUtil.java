...
public class CampaignFinderUtil {
	public static com.liferay.portal.contenttargeting.model.Campaign fetchByG_D_A_U_First(
	...
	public static java.util.List<com.liferay.portal.contenttargeting.model.Campaign> filterFindByG_D_A_U(
		long[] groupIds, java.util.Date date, boolean active,
		long[] userSegmentIds)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
	...
	public static java.util.List<com.liferay.portal.contenttargeting.model.Campaign> findByG_D_A_U(
		long[] groupIds, java.util.Date date, boolean active,
		long[] userSegmentIds)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static com.liferay.portal.contenttargeting.model.Campaign filterFetchByG_D_A_U_First(
		long[] groupIds, java.util.Date date, boolean active,
		long[] userSegmentIds)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
	...
	public static CampaignFinder getFinder() {
		if (_finder == null) {
			_finder = (CampaignFinder)PortletBeanLocatorUtil.locate(com.liferay.portal.contenttargeting.service.ClpSerializer.getServletContextName(),
