...
public class UserSegmentServiceClp implements UserSegmentService {
	public UserSegmentServiceClp(InvokableService invokableService) {
		...
		_methodName4 = "deleteUserSegment";

		_methodParameterTypes4 = new String[] { "long" };

		_methodName5 = "getUserSegments";

		_methodParameterTypes5 = new String[] { "long" };

		_methodName6 = "getUserSegments";

		_methodParameterTypes6 = new String[] { "long[][]" };

		_methodName7 = "getUserSegmentsCount";

		_methodParameterTypes7 = new String[] { "long" };

		_methodName8 = "getUserSegmentsCount";
	...
	public com.liferay.portal.contenttargeting.model.UserSegment deleteUserSegment(
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					_methodParameterTypes4, new Object[] { userSegmentId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
