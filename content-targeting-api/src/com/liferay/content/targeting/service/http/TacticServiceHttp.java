 ...
 * @see TacticServiceSoap
 * @see HttpPrincipal
 * @see TacticServiceUtil
 * @generated
 */
@ProviderType
public class TacticServiceHttp {
	public static com.liferay.content.targeting.model.Tactic addTactic(
		HttpPrincipal httpPrincipal, long userId, long campaignId,
		...
		try {
			MethodKey methodKey = new MethodKey(TacticServiceUtil.class,
					"addTactic", _addTacticParameterTypes0);
			...
			return (com.liferay.content.targeting.model.Tactic)returnObj;
		}
	...
	public static java.util.List<com.liferay.content.targeting.model.Tactic> getTactics(
		...
		try {
			MethodKey methodKey = new MethodKey(TacticServiceUtil.class,
					"getTactics", _getTacticsParameterTypes1);
			...
			return (java.util.List<com.liferay.content.targeting.model.Tactic>)returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException se) {
			_log.error(se, se);
	...
	public static com.liferay.content.targeting.model.Tactic updateTactic(
		HttpPrincipal httpPrincipal, long tacticId, long campaignId,
		java.util.Map<java.util.Locale, java.lang.String> nameMap,
		java.util.Map<java.util.Locale, java.lang.String> descriptionMap,
		long[] userSegmentsIds,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		...
		try {
			MethodKey methodKey = new MethodKey(TacticServiceUtil.class,
					"updateTactic", _updateTacticParameterTypes2);

			MethodHandler methodHandler = new MethodHandler(methodKey,
					tacticId, campaignId, nameMap, descriptionMap,
