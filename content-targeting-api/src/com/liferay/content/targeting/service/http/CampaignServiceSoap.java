 ...
 * is translated to an array of {@link com.liferay.content.targeting.model.CampaignSoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.content.targeting.model.Campaign}, that is translated to a
 * {@link com.liferay.content.targeting.model.CampaignSoap}. Methods that SOAP cannot
...
public class CampaignServiceSoap {
	...
	public static com.liferay.content.targeting.model.CampaignSoap deleteCampaign(
		...
		try {
			com.liferay.content.targeting.model.Campaign returnValue = CampaignServiceUtil.deleteCampaign(campaignId);
	...
	public static com.liferay.content.targeting.model.CampaignSoap fetchCurrentMaxPriorityCampaign(
		long[] groupIds, long[] userSegmentIds) throws RemoteException {
		try {
			com.liferay.content.targeting.model.Campaign returnValue = CampaignServiceUtil.fetchCurrentMaxPriorityCampaign(groupIds,
					userSegmentIds);
	...
	public static com.liferay.content.targeting.model.CampaignSoap[] getCampaigns(
		long groupId) throws RemoteException {
		try {
			java.util.List<com.liferay.content.targeting.model.Campaign> returnValue =
				CampaignServiceUtil.getCampaigns(groupId);

			return com.liferay.content.targeting.model.CampaignSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
