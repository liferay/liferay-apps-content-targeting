 ...
 * is translated to an array of {@link com.liferay.content.targeting.model.RuleInstanceSoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.content.targeting.model.RuleInstance}, that is translated to a
 * {@link com.liferay.content.targeting.model.RuleInstanceSoap}. Methods that SOAP cannot
...
public class RuleInstanceServiceSoap {
	public static com.liferay.content.targeting.model.RuleInstanceSoap addRuleInstance(
		...
		try {
			...
			return com.liferay.content.targeting.model.RuleInstanceSoap.toSoapModel(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
	...
	public static com.liferay.content.targeting.model.RuleInstanceSoap deleteRuleInstance(
		long ruleInstanceId) throws RemoteException {
		try {
			com.liferay.content.targeting.model.RuleInstance returnValue = RuleInstanceServiceUtil.deleteRuleInstance(ruleInstanceId);
	...
	public static com.liferay.content.targeting.model.RuleInstanceSoap[] getRuleInstances(
		long userSegmentId) throws RemoteException {
		try {
			java.util.List<com.liferay.content.targeting.model.RuleInstance> returnValue =
				RuleInstanceServiceUtil.getRuleInstances(userSegmentId);

			return com.liferay.content.targeting.model.RuleInstanceSoap.toSoapModels(returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
