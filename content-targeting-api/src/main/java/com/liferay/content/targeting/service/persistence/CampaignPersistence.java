...
public interface CampaignPersistence extends BasePersistence<Campaign> {
	...
	* @return the matching campaigns
	*/
	public java.util.List<Campaign> findByG_U(long groupId, long userId);
	...
	* @return the matching campaigns that the user has permission to view
	*/
	public java.util.List<Campaign> filterFindByG_U(long groupId, long userId);
	...
	* @return the matching campaigns that the user has permission to view
	*/
	public java.util.List<Campaign> filterFindByG_U(long[] groupIds, long userId);
	...
	* @return the range of matching campaigns that the user has permission to view
	*/
	public java.util.List<Campaign> filterFindByG_U(long[] groupIds,
	...
	* @return the matching campaigns
	*/
	public java.util.List<Campaign> findByG_U(long[] groupIds, long userId);
