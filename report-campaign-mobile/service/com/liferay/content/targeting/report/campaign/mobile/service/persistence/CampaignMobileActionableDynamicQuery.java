 ...
 * @generated
 */
public abstract class CampaignMobileActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CampaignMobileActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CampaignMobileLocalServiceUtil.getService());
		setClass(CampaignMobile.class);

		setClassLoader(com.liferay.content.targeting.report.campaign.mobile.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("campaignMobileId");
	}
}