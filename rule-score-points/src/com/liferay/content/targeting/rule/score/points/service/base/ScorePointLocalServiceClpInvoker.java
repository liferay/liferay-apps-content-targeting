...
public class ScorePointLocalServiceClpInvoker {
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return ScorePointLocalServiceUtil.addScorePoint((com.liferay.content.targeting.rule.score.points.model.ScorePoint)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return ScorePointLocalServiceUtil.deleteScorePoint((com.liferay.content.targeting.rule.score.points.model.ScorePoint)arguments[0]);
		}
