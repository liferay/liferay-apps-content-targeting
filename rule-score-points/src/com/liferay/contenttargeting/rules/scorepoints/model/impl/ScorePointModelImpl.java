...
/**
 * The base model implementation for the ScorePoint service. Represents a row in the &quot;ContentTargeting_ScorePoint&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ScorePointModelImpl extends BaseModelImpl<ScorePoint>
	 ...
	 */
	public static final String TABLE_NAME = "ContentTargeting_ScorePoint";
	...
	public static final String TABLE_SQL_CREATE = "create table ContentTargeting_ScorePoint (uuid_ VARCHAR(75) null,scorePointId LONG not null primary key,anonymousUserId LONG,userSegmentId LONG,points LONG)";
	public static final String TABLE_SQL_DROP = "drop table ContentTargeting_ScorePoint";
	public static final String ORDER_BY_JPQL = " ORDER BY scorePoint.anonymousUserId DESC";
	public static final String ORDER_BY_SQL = " ORDER BY ContentTargeting_ScorePoint.anonymousUserId DESC";
