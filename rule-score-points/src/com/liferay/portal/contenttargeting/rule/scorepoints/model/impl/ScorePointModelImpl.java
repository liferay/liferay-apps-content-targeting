...
import com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePointModel;
import com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePointSoap;
...
/**
 * The base model implementation for the ScorePoint service. Represents a row in the &quot;ContentTargeting_ScorePoints_ScorePoint&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePointModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ScorePointImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ScorePointImpl
 * @see com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint
 * @see com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePointModel
 * @generated
 */
@JSON(strict = true)
public class ScorePointModelImpl extends BaseModelImpl<ScorePoint>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a score point model instance should use the {@link com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint} interface instead.
	 */
	public static final String TABLE_NAME = "ContentTargeting_ScorePoints_ScorePoint";
	...
	public static final String TABLE_SQL_CREATE = "create table ContentTargeting_ScorePoints_ScorePoint (uuid_ VARCHAR(75) null,scorePointId LONG not null primary key,anonymousUserId LONG,userSegmentId LONG,points LONG)";
	public static final String TABLE_SQL_DROP = "drop table ContentTargeting_ScorePoints_ScorePoint";
	public static final String ORDER_BY_JPQL = " ORDER BY scorePoint.anonymousUserId DESC";
	public static final String ORDER_BY_SQL = " ORDER BY ContentTargeting_ScorePoints_ScorePoint.anonymousUserId DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.portal.contenttargeting.rule.scorepoints.model.ScorePoint"));
