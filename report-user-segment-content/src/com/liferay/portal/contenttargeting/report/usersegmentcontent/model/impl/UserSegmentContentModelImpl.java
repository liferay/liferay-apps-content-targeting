...
import com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContentModel;
import com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContentSoap;
...
/**
 * The base model implementation for the UserSegmentContent service. Represents a row in the &quot;ContentTargeting_UserSegmentContentReport_UserSegmentContent&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContentModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link UserSegmentContentImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see UserSegmentContentImpl
 * @see com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent
 * @see com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContentModel
 * @generated
 */
@JSON(strict = true)
public class UserSegmentContentModelImpl extends BaseModelImpl<UserSegmentContent>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a user segment content model instance should use the {@link com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent} interface instead.
	 */
	public static final String TABLE_NAME = "ContentTargeting_UserSegmentContentReport_UserSegmentContent";
	...
	public static final String TABLE_SQL_CREATE = "create table ContentTargeting_UserSegmentContentReport_UserSegmentContent (userSegmentContentId LONG not null primary key,userSegmentId LONG,className VARCHAR(75) null,classPK LONG,eventType VARCHAR(75) null,count INTEGER,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table ContentTargeting_UserSegmentContentReport_UserSegmentContent";
	public static final String ORDER_BY_JPQL = " ORDER BY userSegmentContent.modifiedDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY ContentTargeting_UserSegmentContentReport_UserSegmentContent.modifiedDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.portal.contenttargeting.report.usersegmentcontent.model.UserSegmentContent"));
