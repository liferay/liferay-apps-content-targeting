 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link AnonymousUserModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AnonymousUserImpl}.
 * </p>
 *
...
public class AnonymousUserModelImpl extends BaseModelImpl<AnonymousUser>
	...
	static {
		...
		TABLE_COLUMNS_MAP.put("lastIp", Types.VARCHAR);
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.content.targeting.anonymous.users.model.AnonymousUser"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.content.targeting.anonymous.users.model.AnonymousUser"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.service.util.ServiceProps.get(
	...
	public static final long ANONYMOUSUSERID_COLUMN_BITMASK = 16L;
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.content.targeting.anonymous.users.service.util.ServiceProps.get(
	...
	public void resetOriginalValues() {
		...
		anonymousUserModelImpl._setModifiedDate = false;
	...
	private static final ClassLoader _classLoader = AnonymousUser.class.getClassLoader();
