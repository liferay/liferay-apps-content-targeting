...
package com.liferay.content.targeting.tracking.action.form;
...
public class FormTrackingAction extends BaseJSPTrackingAction {
	...
	@Override
	@Reference(
		target = "(osgi.web.symbolicname=com.liferay.content.targeting.tracking.action.form)",
		unbind = "-"
	)
