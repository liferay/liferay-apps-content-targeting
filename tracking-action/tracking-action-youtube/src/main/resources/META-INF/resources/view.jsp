...
<c:if test="<%= !trackingYoutubeEnabled %>">
...
<aui:input helpMessage="enter-the-id-of-the-youtube-video-to-be-tracked" label="youtube-video-id" name='<%= ContentTargetingUtil.GUID_REPLACEMENT + "elementId" %>' type="text" value="<%= elementId %>">
	<aui:validator name="required" />
</aui:input>
