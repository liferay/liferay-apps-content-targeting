...
import com.liferay.content.targeting.report.campaign.newsletter.model.NewsletterClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"com.liferay.content.targeting.report.newsletter-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "com.liferay.content.targeting.report.newsletter";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.content.targeting.report.campaign.newsletter.model.impl.NewsletterImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.liferay.content.targeting.report.campaign.newsletter.NoSuchNewsletterException")) {
			return new com.liferay.content.targeting.report.campaign.newsletter.NoSuchNewsletterException();
		}
