...
/**
 * The base model implementation for the Newsletter service. Represents a row in the &quot;CT_CNReport_Newsletter&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class NewsletterModelImpl extends BaseModelImpl<Newsletter>
	 ...
	 */
	public static final String TABLE_NAME = "CT_CNReport_Newsletter";
	...
	public static final String TABLE_SQL_CREATE = "create table CT_CNReport_Newsletter (newsletterId LONG not null primary key,campaignId LONG,alias_ VARCHAR(75) null,elementId VARCHAR(75) null,eventType VARCHAR(75) null,count INTEGER,modifiedDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table CT_CNReport_Newsletter";
	public static final String ORDER_BY_JPQL = " ORDER BY newsletter.modifiedDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY CT_CNReport_Newsletter.modifiedDate DESC";
