...
public class AnalyticsReferrerPersistenceImpl extends BasePersistenceImpl<AnalyticsReferrer>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_A = new FinderPath(AnalyticsReferrerModelImpl.ENTITY_CACHE_ENABLED,
			AnalyticsReferrerModelImpl.FINDER_CACHE_ENABLED,
			AnalyticsReferrerImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_A = new FinderPath(AnalyticsReferrerModelImpl.ENTITY_CACHE_ENABLED,
			AnalyticsReferrerModelImpl.FINDER_CACHE_ENABLED,
			AnalyticsReferrerImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByA",
			new String[] { Long.class.getName() },
			AnalyticsReferrerModelImpl.ANALYTICSEVENTID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_A = new FinderPath(AnalyticsReferrerModelImpl.ENTITY_CACHE_ENABLED,
			AnalyticsReferrerModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<AnalyticsReferrer> findByA(long analyticsEventId)
		throws SystemException {
		return findByA(analyticsEventId, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}
	 ...
	 */
	@Override
	public List<AnalyticsReferrer> findByA(long analyticsEventId, int start,
		int end) throws SystemException {
		return findByA(analyticsEventId, start, end, null);
	}
	...
	public List<AnalyticsReferrer> findByA(long analyticsEventId, int start,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_A_ANALYTICSEVENTID_2);
	 ...
	 */
	@Override
	public AnalyticsReferrer findByA_First(long analyticsEventId,
		OrderByComparator orderByComparator)
		throws NoSuchAnalyticsReferrerException, SystemException {
		AnalyticsReferrer analyticsReferrer = fetchByA_First(analyticsEventId,
				orderByComparator);
	 ...
	 */
	@Override
	public AnalyticsReferrer fetchByA_First(long analyticsEventId,
		OrderByComparator orderByComparator) throws SystemException {
		List<AnalyticsReferrer> list = findByA(analyticsEventId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public AnalyticsReferrer findByA_Last(long analyticsEventId,
		OrderByComparator orderByComparator)
		throws NoSuchAnalyticsReferrerException, SystemException {
		AnalyticsReferrer analyticsReferrer = fetchByA_Last(analyticsEventId,
				orderByComparator);
	 ...
	 */
	@Override
	public AnalyticsReferrer fetchByA_Last(long analyticsEventId,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByA(analyticsEventId);

		if (count == 0) {
			return null;
		}

		List<AnalyticsReferrer> list = findByA(analyticsEventId, count - 1,
	 ...
	 */
	@Override
	public AnalyticsReferrer[] findByA_PrevAndNext(long analyticsReferrerId,
		long analyticsEventId, OrderByComparator orderByComparator)
		throws NoSuchAnalyticsReferrerException, SystemException {
		AnalyticsReferrer analyticsReferrer = findByPrimaryKey(analyticsReferrerId);
		...
		try {
			...
			array[0] = getByA_PrevAndNext(session, analyticsReferrer,
					analyticsEventId, orderByComparator, true);

			array[1] = analyticsReferrer;

			array[2] = getByA_PrevAndNext(session, analyticsReferrer,
					analyticsEventId, orderByComparator, false);
	...
	protected AnalyticsReferrer getByA_PrevAndNext(Session session,
		AnalyticsReferrer analyticsReferrer, long analyticsEventId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByA(long analyticsEventId) throws SystemException {
		for (AnalyticsReferrer analyticsReferrer : findByA(analyticsEventId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(analyticsReferrer);
		}
	}
	 ...
	 */
	@Override
	public int countByA(long analyticsEventId) throws SystemException {
	...
	private static final String _FINDER_COLUMN_A_ANALYTICSEVENTID_2 = "analyticsReferrer.analyticsEventId = ?";
