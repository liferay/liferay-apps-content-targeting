...
import com.liferay.portal.contenttargeting.analytics.model.AnalyticsEventModel;
import com.liferay.portal.contenttargeting.analytics.model.AnalyticsEventSoap;
...
/**
 * The base model implementation for the AnalyticsEvent service. Represents a row in the &quot;ContentTargeting_Analytics_AnalyticsEvent&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link com.liferay.portal.contenttargeting.analytics.model.AnalyticsEventModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link AnalyticsEventImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see AnalyticsEventImpl
 * @see com.liferay.portal.contenttargeting.analytics.model.AnalyticsEvent
 * @see com.liferay.portal.contenttargeting.analytics.model.AnalyticsEventModel
 * @generated
 */
@JSON(strict = true)
public class AnalyticsEventModelImpl extends BaseModelImpl<AnalyticsEvent>
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a analytics event model instance should use the {@link com.liferay.portal.contenttargeting.analytics.model.AnalyticsEvent} interface instead.
	 */
	public static final String TABLE_NAME = "ContentTargeting_Analytics_AnalyticsEvent";
	...
	public static final String TABLE_SQL_CREATE = "create table ContentTargeting_Analytics_AnalyticsEvent (analyticsEventId LONG not null primary key,companyId LONG,userId LONG,anonymousUserId LONG,className VARCHAR(75) null,classPK LONG,referrerClassName VARCHAR(75) null,referrerClassPK LONG,elementId VARCHAR(75) null,eventType VARCHAR(75) null,clientIP VARCHAR(75) null,userAgent STRING null,languageId VARCHAR(75) null,URL STRING null,additionalInfo TEXT null,createDate DATE null)";
	public static final String TABLE_SQL_DROP = "drop table ContentTargeting_Analytics_AnalyticsEvent";
	public static final String ORDER_BY_JPQL = " ORDER BY analyticsEvent.createDate DESC";
	public static final String ORDER_BY_SQL = " ORDER BY ContentTargeting_Analytics_AnalyticsEvent.createDate DESC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.portal.contenttargeting.analytics.model.AnalyticsEvent"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.portal.contenttargeting.analytics.model.AnalyticsEvent"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.com.liferay.portal.contenttargeting.analytics.model.AnalyticsEvent"));
