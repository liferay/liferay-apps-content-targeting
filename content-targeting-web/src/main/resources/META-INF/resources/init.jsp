...
page import="com.liferay.content.targeting.web.display.context.ContentTargetingViewUserSegmentDisplayContext" %><%@
...
page import="com.liferay.portal.kernel.portlet.configuration.icon.BaseJSPPortletConfigurationIcon" %><%@
