...
page import="com.liferay.content.targeting.portlet.display.context.ContentTargetingViewTacticsDisplayContext" %><%@
page import="com.liferay.content.targeting.portlet.display.context.ContentTargetingViewUserSegmentDisplayContext" %><%@
