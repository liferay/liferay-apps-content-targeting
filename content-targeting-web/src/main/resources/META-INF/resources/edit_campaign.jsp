...
<%
ContentTargetingEditCampaignDisplayContext contentTargetingEditCampaignDisplayContext = (ContentTargetingEditCampaignDisplayContext)renderRequest.getAttribute("contentTargetingEditCampaignDisplayContext");
