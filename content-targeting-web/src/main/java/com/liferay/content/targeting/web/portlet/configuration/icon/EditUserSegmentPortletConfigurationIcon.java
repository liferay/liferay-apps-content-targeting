...
@Component(
	...
	property = {
		...
		"path=" + ContentTargetingMVCCommand.VIEW_USER_SEGMENT
	},
	service = PortletConfigurationIcon.class
)
public class EditUserSegmentPortletConfigurationIcon
	...
	public String getURL(
		...
		portletURL.setParameter("userSegmentId", String.valueOf(userSegmentId));
		portletURL.setParameter(
