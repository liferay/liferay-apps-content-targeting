...
public class ReportInstancePersistenceImpl extends BasePersistenceImpl<ReportInstance>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_U_C_C = new FinderPath(ReportInstanceModelImpl.ENTITY_CACHE_ENABLED,
			ReportInstanceModelImpl.FINDER_CACHE_ENABLED,
			ReportInstanceImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByU_C_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_U_C_C = new FinderPath(ReportInstanceModelImpl.ENTITY_CACHE_ENABLED,
			ReportInstanceModelImpl.FINDER_CACHE_ENABLED,
			ReportInstanceImpl.class,
			...
			ReportInstanceModelImpl.USERID_COLUMN_BITMASK |
			ReportInstanceModelImpl.CLASSNAMEID_COLUMN_BITMASK |
			ReportInstanceModelImpl.CLASSPK_COLUMN_BITMASK |
			ReportInstanceModelImpl.REPORTKEY_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_U_C_C = new FinderPath(ReportInstanceModelImpl.ENTITY_CACHE_ENABLED,
			ReportInstanceModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	/**
	 * Returns all the report instances where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 ...
	 */
	@Override
	public List<ReportInstance> findByU_C_C(long userId, long classNameId,
		long classPK) {
	...
	/**
	 * Returns a range of all the report instances where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ReportInstanceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the report instances where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ReportInstanceModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ReportInstance> findByU_C_C(long userId, long classNameId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ReportInstance reportInstance : list) {
					if ((userId != reportInstance.getUserId()) ||
							(classNameId != reportInstance.getClassNameId()) ||
							(classPK != reportInstance.getClassPK())) {
						list = null;
	...
	/**
	 * Returns the first report instance in the ordered set where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 ...
	 */
	@Override
	public ReportInstance findByU_C_C_First(long userId, long classNameId,
		long classPK, OrderByComparator<ReportInstance> orderByComparator)
		throws NoSuchReportInstanceException {
		ReportInstance reportInstance = fetchByU_C_C_First(userId, classNameId,
	 ...
	 */
	@Override
	public ReportInstance fetchByU_C_C_First(long userId, long classNameId,
		long classPK, OrderByComparator<ReportInstance> orderByComparator) {
		List<ReportInstance> list = findByU_C_C(userId, classNameId, classPK,
	...
	/**
	 * Returns the last report instance in the ordered set where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	 ...
	 */
	@Override
	public ReportInstance findByU_C_C_Last(long userId, long classNameId,
		long classPK, OrderByComparator<ReportInstance> orderByComparator)
		throws NoSuchReportInstanceException {
		ReportInstance reportInstance = fetchByU_C_C_Last(userId, classNameId,
				classPK, orderByComparator);
	 ...
	 */
	@Override
	public ReportInstance fetchByU_C_C_Last(long userId, long classNameId,
		long classPK, OrderByComparator<ReportInstance> orderByComparator) {
	...
	/**
	 * Returns the report instances before and after the current report instance in the ordered set where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param reportInstanceId the primary key of the current report instance
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public ReportInstance[] findByU_C_C_PrevAndNext(long reportInstanceId,
		...
		try {
			...
			array[0] = getByU_C_C_PrevAndNext(session, reportInstance, userId,
					classNameId, classPK, orderByComparator, true);

			array[1] = reportInstance;

			array[2] = getByU_C_C_PrevAndNext(session, reportInstance, userId,
					classNameId, classPK, orderByComparator, false);
	...
	protected ReportInstance getByU_C_C_PrevAndNext(Session session,
		ReportInstance reportInstance, long userId, long classNameId,
		long classPK, OrderByComparator<ReportInstance> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the report instances where userId = &#63; and classNameId = &#63; and classPK = &#63; from the database.
	 *
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	...
	public void removeByU_C_C(long userId, long classNameId, long classPK) {
		for (ReportInstance reportInstance : findByU_C_C(userId, classNameId,
	...
	/**
	 * Returns the number of report instances where userId = &#63; and classNameId = &#63; and classPK = &#63;.
	 *
	 * @param userId the user ID
	 * @param classNameId the class name ID
	 * @param classPK the class p k
	...
	private static final String _FINDER_COLUMN_U_C_C_USERID_2 = "reportInstance.userId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_C_CLASSNAMEID_2 = "reportInstance.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_U_C_C_CLASSPK_2 = "reportInstance.classPK = ?";
	...
	public ReportInstance updateImpl(ReportInstance reportInstance) {
		...
		if (isNew || !ReportInstanceModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((reportInstanceModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						reportInstanceModelImpl.getOriginalUserId(),
						reportInstanceModelImpl.getOriginalClassNameId(),
						reportInstanceModelImpl.getOriginalClassPK()
					};
				...
				args = new Object[] {
						reportInstanceModelImpl.getUserId(),
						reportInstanceModelImpl.getClassNameId(),
						reportInstanceModelImpl.getClassPK()
					};
