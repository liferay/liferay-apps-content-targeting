...
public class UserSegmentPersistenceImpl extends BasePersistenceImpl<UserSegment>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U = new FinderPath(UserSegmentModelImpl.ENTITY_CACHE_ENABLED,
			UserSegmentModelImpl.FINDER_CACHE_ENABLED, UserSegmentImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_U = new FinderPath(UserSegmentModelImpl.ENTITY_CACHE_ENABLED,
			UserSegmentModelImpl.FINDER_CACHE_ENABLED, UserSegmentImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_U",
			new String[] { Long.class.getName(), Long.class.getName() },
			UserSegmentModelImpl.GROUPID_COLUMN_BITMASK |
			UserSegmentModelImpl.USERID_COLUMN_BITMASK |
			UserSegmentModelImpl.MODIFIEDDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_U = new FinderPath(UserSegmentModelImpl.ENTITY_CACHE_ENABLED,
			UserSegmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_U",
			new String[] { Long.class.getName(), Long.class.getName() });
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_U = new FinderPath(UserSegmentModelImpl.ENTITY_CACHE_ENABLED,
			UserSegmentModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<UserSegment> findByG_U(long groupId, long userId) {
	 ...
	 */
	@Override
	public List<UserSegment> findByG_U(long groupId, long userId, int start,
		int end) {
	 ...
	 */
	@Override
	public UserSegment findByG_U_First(long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator)
		throws NoSuchUserSegmentException {
		UserSegment userSegment = fetchByG_U_First(groupId, userId,
				orderByComparator);
	 ...
	 */
	@Override
	public UserSegment fetchByG_U_First(long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator) {
		List<UserSegment> list = findByG_U(groupId, userId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public UserSegment findByG_U_Last(long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator)
		throws NoSuchUserSegmentException {
		UserSegment userSegment = fetchByG_U_Last(groupId, userId,
				orderByComparator);
	 ...
	 */
	@Override
	public UserSegment fetchByG_U_Last(long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator) {
		...
		List<UserSegment> list = findByG_U(groupId, userId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public UserSegment[] findByG_U_PrevAndNext(long userSegmentId,
		...
		try {
			...
			array[0] = getByG_U_PrevAndNext(session, userSegment, groupId,
					userId, orderByComparator, true);

			array[1] = userSegment;

			array[2] = getByG_U_PrevAndNext(session, userSegment, groupId,
	...
	protected UserSegment getByG_U_PrevAndNext(Session session,
		UserSegment userSegment, long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<UserSegment> filterFindByG_U(long groupId, long userId) {
	 ...
	 */
	@Override
	public UserSegment[] filterFindByG_U_PrevAndNext(long userSegmentId,
		long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator)
		throws NoSuchUserSegmentException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_U_PrevAndNext(userSegmentId, groupId, userId,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_U_PrevAndNext(session, userSegment,
					groupId, userId, orderByComparator, true);

			array[1] = userSegment;

			array[2] = filterGetByG_U_PrevAndNext(session, userSegment,
	...
	protected UserSegment filterGetByG_U_PrevAndNext(Session session,
		UserSegment userSegment, long groupId, long userId,
		OrderByComparator<UserSegment> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<UserSegment> filterFindByG_U(long[] groupIds, long userId) {
	 ...
	 */
	@Override
	public List<UserSegment> findByG_U(long[] groupIds, long userId) {
	 ...
	 */
	@Override
	public List<UserSegment> findByG_U(long[] groupIds, long userId, int start,
		int end) {
	...
	public List<UserSegment> findByG_U(long[] groupIds, long userId, int start,
		...
		if (retrieveFromCache) {
			list = (List<UserSegment>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U,
					finderArgs, this);
	...
	public void removeByG_U(long groupId, long userId) {
		for (UserSegment userSegment : findByG_U(groupId, userId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(userSegment);
		}
	}
	...
	private static final String _FINDER_COLUMN_G_U_GROUPID_2 = "userSegment.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_U_GROUPID_7 = "userSegment.groupId IN (";
	private static final String _FINDER_COLUMN_G_U_USERID_2 = "userSegment.userId = ?";
	...
	public UserSegment updateImpl(UserSegment userSegment) {
		...
		if (isNew || !UserSegmentModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((userSegmentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						userSegmentModelImpl.getOriginalGroupId(),
						userSegmentModelImpl.getOriginalUserId()
					};
				...
				args = new Object[] {
						userSegmentModelImpl.getGroupId(),
						userSegmentModelImpl.getUserId()
					};
