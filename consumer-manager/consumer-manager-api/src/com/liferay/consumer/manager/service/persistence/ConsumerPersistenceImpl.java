...
public class ConsumerPersistenceImpl extends BasePersistenceImpl<Consumer>
    ...
    public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(ConsumerModelImpl.ENTITY_CACHE_ENABLED,
            ...
            ConsumerModelImpl.NAME_COLUMN_BITMASK);
    ...
    public static final FinderPath FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY = new FinderPath(ConsumerModelImpl.ENTITY_CACHE_ENABLED,
            ConsumerModelImpl.FINDER_CACHE_ENABLED, ConsumerImpl.class,
            FINDER_CLASS_NAME_ENTITY, "fetchByCompanyIdAndConsumerKey",
            new String[] { Long.class.getName(), String.class.getName() },
            ConsumerModelImpl.COMPANYID_COLUMN_BITMASK |
            ConsumerModelImpl.CONSUMERKEY_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_COMPANYIDANDCONSUMERKEY = new FinderPath(ConsumerModelImpl.ENTITY_CACHE_ENABLED,
            ConsumerModelImpl.FINDER_CACHE_ENABLED, Long.class,
            FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
            "countByCompanyIdAndConsumerKey",
            new String[] { Long.class.getName(), String.class.getName() });
    private static final String _FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_COMPANYID_2 =
        "consumer.companyId = ? AND ";
    private static final String _FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_1 =
        "consumer.consumerKey IS NULL";
    private static final String _FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_2 =
        "consumer.consumerKey = ?";
    private static final String _FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_3 =
        "(consumer.consumerKey IS NULL OR consumer.consumerKey = '')";
     ...
     */
    @Override
    public Consumer findByCompanyIdAndConsumerKey(long companyId,
        String consumerKey) throws NoSuchConsumerException, SystemException {
        Consumer consumer = fetchByCompanyIdAndConsumerKey(companyId,
                consumerKey);
     ...
     */
    @Override
    public Consumer fetchByCompanyIdAndConsumerKey(long companyId,
        String consumerKey) throws SystemException {
        return fetchByCompanyIdAndConsumerKey(companyId, consumerKey, true);
    }
    ...
    public Consumer fetchByCompanyIdAndConsumerKey(long companyId,
        ...
        if (retrieveFromCache) {
            result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY,
                    finderArgs, this);
        }
        ...
        if (result == null) {
            ...
            query.append(_FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_COMPANYID_2);

            boolean bindConsumerKey = false;

            if (consumerKey == null) {
                query.append(_FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_1);
            } else if (consumerKey.equals(StringPool.BLANK)) {
                query.append(_FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_3);
            } else {
                bindConsumerKey = true;

                query.append(_FINDER_COLUMN_COMPANYIDANDCONSUMERKEY_CONSUMERKEY_2);
            }
            ...
            try {
                ...
                if (list.isEmpty()) {
                    FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY,
                        finderArgs, list);
                } else {
                ...
                FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY,
                    finderArgs);
     ...
     */
    @Override
    public Consumer removeByCompanyIdAndConsumerKey(long companyId,
        String consumerKey) throws NoSuchConsumerException, SystemException {
        Consumer consumer = findByCompanyIdAndConsumerKey(companyId, consumerKey);
     ...
     */
    @Override
    public int countByCompanyIdAndConsumerKey(long companyId, String consumerKey)
        throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_COMPANYIDANDCONSUMERKEY;
    ...
    protected void cacheUniqueFindersCache(Consumer consumer) {
        if (consumer.isNew()) {
            ...
            FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_COMPANYIDANDCONSUMERKEY,
                args, Long.valueOf(1));
            FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY,
                args, consumer);
        } else {
            ...
            if ((consumerModelImpl.getColumnBitmask() &
                    FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        consumer.getCompanyId(), consumer.getConsumerKey()
                    };
    ...
    protected void clearUniqueFindersCache(Consumer consumer) {
        ...
        FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_COMPANYIDANDCONSUMERKEY,
            args);
        FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_COMPANYIDANDCONSUMERKEY,
            args);
