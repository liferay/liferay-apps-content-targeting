...
public class ConsumerExtensionInstancePersistenceImpl
    ...
    public static final FinderPath FINDER_PATH_FETCH_BY_K_C = new FinderPath(ConsumerExtensionInstanceModelImpl.ENTITY_CACHE_ENABLED,
            ConsumerExtensionInstanceModelImpl.FINDER_CACHE_ENABLED,
            ...
            ConsumerExtensionInstanceModelImpl.CONSUMEREXTENSIONKEY_COLUMN_BITMASK |
            ConsumerExtensionInstanceModelImpl.CONSUMERID_COLUMN_BITMASK);
    public static final FinderPath FINDER_PATH_COUNT_BY_K_C = new FinderPath(ConsumerExtensionInstanceModelImpl.ENTITY_CACHE_ENABLED,
            ConsumerExtensionInstanceModelImpl.FINDER_CACHE_ENABLED,
            Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
            "countByK_C",
            new String[] { String.class.getName(), Long.class.getName() });
    private static final String _FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_1 = "consumerExtensionInstance.consumerExtensionKey IS NULL AND ";
    private static final String _FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_2 = "consumerExtensionInstance.consumerExtensionKey = ? AND ";
    private static final String _FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_3 = "(consumerExtensionInstance.consumerExtensionKey IS NULL OR consumerExtensionInstance.consumerExtensionKey = '') AND ";
    private static final String _FINDER_COLUMN_K_C_CONSUMERID_2 = "consumerExtensionInstance.consumerId = ?";
     ...
     */
    @Override
    public ConsumerExtensionInstance findByK_C(String consumerExtensionKey,
        long consumerId)
        throws NoSuchConsumerExtensionInstanceException, SystemException {
        ConsumerExtensionInstance consumerExtensionInstance = fetchByK_C(consumerExtensionKey,
                consumerId);
     ...
     */
    @Override
    public ConsumerExtensionInstance fetchByK_C(String consumerExtensionKey,
        long consumerId) throws SystemException {
        return fetchByK_C(consumerExtensionKey, consumerId, true);
    }
    ...
    @Override
    public ConsumerExtensionInstance fetchByK_C(String consumerExtensionKey,
        long consumerId, boolean retrieveFromCache) throws SystemException {
        Object[] finderArgs = new Object[] { consumerExtensionKey, consumerId };

        Object result = null;

        if (retrieveFromCache) {
            result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_K_C,
                    finderArgs, this);
        }

        if (result instanceof ConsumerExtensionInstance) {
            ConsumerExtensionInstance consumerExtensionInstance = (ConsumerExtensionInstance) result;

            if (!Validator.equals(consumerExtensionKey,
                        consumerExtensionInstance.getConsumerExtensionKey()) ||
                    (consumerId != consumerExtensionInstance.getConsumerId())) {
                result = null;
            }
        }
        ...
        if (result == null) {
            ...
            if (consumerExtensionKey == null) {
                query.append(_FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_1);
            } else if (consumerExtensionKey.equals(StringPool.BLANK)) {
                query.append(_FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_3);
            } else {
                bindConsumerExtensionKey = true;

                query.append(_FINDER_COLUMN_K_C_CONSUMEREXTENSIONKEY_2);
            }

            query.append(_FINDER_COLUMN_K_C_CONSUMERID_2);
            ...
            try {
                ...
                if (list.isEmpty()) {
                    FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_K_C,
                        finderArgs, list);
                } else {
                    if ((list.size() > 1) && _log.isWarnEnabled()) {
                        _log.warn(
                            "ConsumerExtensionInstancePersistenceImpl.fetchByK_C(String, long, boolean) with parameters (" +
                            StringUtil.merge(finderArgs) +
                            ") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
                    }

                    ConsumerExtensionInstance consumerExtensionInstance = list.get(0);

                    result = consumerExtensionInstance;

                    cacheResult(consumerExtensionInstance);

                    if ((consumerExtensionInstance.getConsumerExtensionKey() == null) ||
                            !consumerExtensionInstance.getConsumerExtensionKey()
                                                          .equals(consumerExtensionKey) ||
                            (consumerExtensionInstance.getConsumerId() != consumerId)) {
                        FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_K_C,
                            finderArgs, consumerExtensionInstance);
                    }
                }
            } catch (Exception e) {
                FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_K_C,
                    finderArgs);
        ...
        if (result instanceof List<?>) {
            ...
            return (ConsumerExtensionInstance) result;
        }
    }
     ...
     */
    @Override
    public ConsumerExtensionInstance removeByK_C(String consumerExtensionKey,
        long consumerId)
        throws NoSuchConsumerExtensionInstanceException, SystemException {
        ConsumerExtensionInstance consumerExtensionInstance = findByK_C(consumerExtensionKey,
                consumerId);
     ...
     */
    @Override
    public int countByK_C(String consumerExtensionKey, long consumerId)
        throws SystemException {
        FinderPath finderPath = FINDER_PATH_COUNT_BY_K_C;
    ...
    public void clearCache(ConsumerExtensionInstance consumerExtensionInstance) {
        ...
        clearUniqueFindersCache(consumerExtensionInstance);
    }
    ...
    protected void cacheUniqueFindersCache(
        ...
        if (consumerExtensionInstance.isNew()) {
            ...
            FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_K_C, args,
                Long.valueOf(1));
            FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_K_C, args,
                consumerExtensionInstance);
        } else {
            ConsumerExtensionInstanceModelImpl consumerExtensionInstanceModelImpl =
                (ConsumerExtensionInstanceModelImpl) consumerExtensionInstance;

            if ((consumerExtensionInstanceModelImpl.getColumnBitmask() &
                    FINDER_PATH_FETCH_BY_K_C.getColumnBitmask()) != 0) {
                Object[] args = new Object[] {
                        consumerExtensionInstance.getConsumerExtensionKey(),
                        consumerExtensionInstance.getConsumerId()
                    };
    ...
    protected void clearUniqueFindersCache(
        ...
        FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_K_C, args);
        FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_K_C, args);
    ...
    public ConsumerExtensionInstance updateImpl(
        ...
        clearUniqueFindersCache(consumerExtensionInstance);
        cacheUniqueFindersCache(consumerExtensionInstance);
