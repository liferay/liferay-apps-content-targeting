...
public class ConsumerExtensionInstancePersistenceImpl
	 ...
	 */
	@Override
	public ConsumerExtensionInstance findByC_C(String consumerExtensionKey,
		long consumerId)
		throws NoSuchConsumerExtensionInstanceException, SystemException {
		ConsumerExtensionInstance consumerExtensionInstance = fetchByC_C(consumerExtensionKey,
				consumerId);
	 ...
	 */
	@Override
	public ConsumerExtensionInstance fetchByC_C(String consumerExtensionKey,
		long consumerId) throws SystemException {
		return fetchByC_C(consumerExtensionKey, consumerId, true);
	}
	...
	public ConsumerExtensionInstance fetchByC_C(String consumerExtensionKey,
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_C_C_CONSUMERID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"ConsumerExtensionInstancePersistenceImpl.fetchByC_C(String, long, boolean) with parameters (" +
	 ...
	 */
	@Override
	public ConsumerExtensionInstance removeByC_C(String consumerExtensionKey,
		long consumerId)
		throws NoSuchConsumerExtensionInstanceException, SystemException {
		ConsumerExtensionInstance consumerExtensionInstance = findByC_C(consumerExtensionKey,
				consumerId);
	 ...
	 */
	@Override
	public int countByC_C(String consumerExtensionKey, long consumerId)
		throws SystemException {
	...
	private static final String _FINDER_COLUMN_C_C_CONSUMEREXTENSIONKEY_1 = "consumerExtensionInstance.consumerExtensionKey IS NULL AND ";
	private static final String _FINDER_COLUMN_C_C_CONSUMEREXTENSIONKEY_2 = "consumerExtensionInstance.consumerExtensionKey = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CONSUMEREXTENSIONKEY_3 = "(consumerExtensionInstance.consumerExtensionKey IS NULL OR consumerExtensionInstance.consumerExtensionKey = '') AND ";
	private static final String _FINDER_COLUMN_C_C_CONSUMERID_2 = "consumerExtensionInstance.consumerId = ?";
