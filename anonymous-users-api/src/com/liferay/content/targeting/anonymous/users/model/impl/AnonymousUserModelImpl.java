...
public class AnonymousUserModelImpl extends BaseModelImpl<AnonymousUser>
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.api.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.content.targeting.anonymous.users.model.AnonymousUser"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.api.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.content.targeting.anonymous.users.model.AnonymousUser"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.content.targeting.anonymous.users.api.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.content.targeting.anonymous.users.api.util.ServiceProps.get(
