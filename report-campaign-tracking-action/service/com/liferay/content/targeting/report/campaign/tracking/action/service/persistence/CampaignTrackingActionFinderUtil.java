...
public class CampaignTrackingActionFinderUtil {
	...
	public static CampaignTrackingActionFinder getFinder() {
		if (_finder == null) {
			_finder = (CampaignTrackingActionFinder)PortletBeanLocatorUtil.locate(com.liferay.content.targeting.report.campaign.tracking.action.service.ClpSerializer.getServletContextName(),
