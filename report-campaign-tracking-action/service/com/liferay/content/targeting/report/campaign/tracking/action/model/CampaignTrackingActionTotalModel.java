...
/**
 * The base model interface for the CampaignTrackingActionTotal service. Represents a row in the &quot;ContentTargeting_CampaignTAReport_CampaignTrackingActionTotal&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.liferay.content.targeting.report.campaign.tracking.action.model.impl.CampaignTrackingActionTotalModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.liferay.content.targeting.report.campaign.tracking.action.model.impl.CampaignTrackingActionTotalImpl}.
 * </p>
 *
 ...
 * @generated
 */
public interface CampaignTrackingActionTotalModel extends BaseModel<CampaignTrackingActionTotal> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a campaign tracking action total model instance should use the {@link CampaignTrackingActionTotal} interface instead.
	 */
	...
	@Override
	public CampaignTrackingActionTotal toUnescapedModel();
