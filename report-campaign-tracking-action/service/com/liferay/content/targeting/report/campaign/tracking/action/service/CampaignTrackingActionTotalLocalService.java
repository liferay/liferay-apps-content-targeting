...
/**
 * Provides the local service interface for CampaignTrackingActionTotal. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CampaignTrackingActionTotalLocalServiceUtil
...
public interface CampaignTrackingActionTotalLocalService
	extends BaseLocalService, InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CampaignTrackingActionTotalLocalServiceUtil} to access the campaign tracking action total local service. Add custom service methods to {@link com.liferay.content.targeting.report.campaign.tracking.action.service.impl.CampaignTrackingActionTotalLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
