		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"com.liferay.content.targeting.report.campaign.tracking.action-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "com.liferay.content.targeting.report.campaign.tracking.action";
			}
