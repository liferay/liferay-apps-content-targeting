...
import com.liferay.contenttargeting.reports.campaigntrackingaction.model.CampaignTrackingActionClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"com.liferay.portal.content.targeting.report.campaign.tracking.action-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "com.liferay.portal.content.targeting.report.campaign.tracking.action";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.contenttargeting.reports.campaigntrackingaction.model.impl.CampaignTrackingActionImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.liferay.contenttargeting.reports.campaigntrackingaction.NoSuchCampaignTrackingActionException")) {
			return new com.liferay.contenttargeting.reports.campaigntrackingaction.NoSuchCampaignTrackingActionException();
		}
