...
/**
 * Provides the local service interface for CampaignTrackingAction. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see CampaignTrackingActionLocalServiceUtil
...
public interface CampaignTrackingActionLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CampaignTrackingActionLocalServiceUtil} to access the campaign tracking action local service. Add custom service methods to {@link com.liferay.portal.contenttargeting.report.campaigntrackingaction.service.impl.CampaignTrackingActionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
