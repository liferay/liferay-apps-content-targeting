...
public class CampaignTrackingActionFinderUtil {
	...
	public static CampaignTrackingActionFinder getFinder() {
		if (_finder == null) {
			_finder = (CampaignTrackingActionFinder)PortletBeanLocatorUtil.locate(com.liferay.portal.contenttargeting.report.campaigntrackingaction.service.ClpSerializer.getServletContextName(),
