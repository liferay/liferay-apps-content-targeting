 ...
 *
 * <p>
 * Helper methods and all application logic should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the {@link com.liferay.contenttargeting.reports.campaigntrackingaction.model.CampaignTrackingAction} interface.
 * </p>
 *
...
public class CampaignTrackingActionImpl extends CampaignTrackingActionBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a campaign tracking action model instance should use the {@link com.liferay.contenttargeting.reports.campaigntrackingaction.model.CampaignTrackingAction} interface instead.
	 */
