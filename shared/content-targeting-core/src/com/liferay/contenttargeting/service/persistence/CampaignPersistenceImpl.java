...
import com.liferay.contenttargeting.model.impl.CampaignModelImpl;
...
public class CampaignPersistenceImpl extends BasePersistenceImpl<Campaign>
	 ...
	 */
	@Override
	public List<com.liferay.contenttargeting.model.UserSegment> getUserSegments(
	...
	public void addUserSegments(long pk,
		List<com.liferay.contenttargeting.model.UserSegment> userSegments)
		throws SystemException {
		for (com.liferay.contenttargeting.model.UserSegment userSegment : userSegments) {
			campaignToUserSegmentTableMapper.addTableMapping(pk,
				userSegment.getPrimaryKey());
		}
	}
	...
	public void setUserSegments(long pk,
		...
		try {
			...
			for (int i = 0; i < userSegments.size(); i++) {
				com.liferay.contenttargeting.model.UserSegment userSegment = userSegments.get(i);
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.contenttargeting.model.Campaign")));
	...
	protected TableMapper<Campaign, com.liferay.contenttargeting.model.UserSegment> campaignToUserSegmentTableMapper;
