 ...
 * @generated
 */
public abstract class CTUserActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public CTUserActionableDynamicQuery() throws SystemException {
		setBaseLocalService(CTUserLocalServiceUtil.getService());
		setClass(CTUser.class);

		setClassLoader(com.liferay.contenttargeting.service.ClpSerializer.class.getClassLoader());

		setPrimaryKeyPropertyName("CTUserId");
	}
}