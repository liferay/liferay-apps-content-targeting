...
<c:if test='<%= PrefsPropsUtil.getBoolean(company.getCompanyId(), "content.targeting.analytics.web.content.view") && (assetEntry != null) && Validator.isNotNull(userSegmentIds) %>'>
